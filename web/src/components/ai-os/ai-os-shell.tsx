 ...
 * Top status bar, ambient background, optional side rail and a content area.
 * Later milestones slot the holographic sphere, tool panels and command
 * console into this shell without disturbing the page logic beneath.
 */
